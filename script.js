(() => {
  ...
  const RAFFLE_ENTRIES = [
    ...
    { number: 20, owner: "Kelly Botelho" },
    { number: 21, owner: "Neide Mundim" },
    { number: 22, owner: "Lucy Rocha" },
    ...
    { number: 50, owner: "Daniela Tokarski" },
    { number: 51, owner: "Alex Capuzzo" },
    { number: 52, owner: "Namorado da Milena" },
    ...
    { number: 100, owner: "Eduardo Gomes" },
    { number: 101, owner: "Eduardo Gomes" },
    ...
    { number: 161, owner: "Raquel de Farias" },
    ...
    { number: 171, owner: "Regis Humberto" },
